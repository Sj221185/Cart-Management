    ...
    datos.forEach(element => {
        tabla.append(`
            <tr>
                ...
                <td>
                    <button class="btn btn-primary" onclick="editar(${element.documento})">Edit</button>
                    <button class="btn btn-danger" onclick="eliminar(${element.documento})">Eliminate</button>
                </td>    
            </tr>
        `);
    });
